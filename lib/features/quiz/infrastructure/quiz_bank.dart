...
abstract final class QuizBank {
  ...
  static final List<Quiz> _quizzes = [
    _make(
      ...
      correctIndex: 0,
      shortReason:
          'A9o は UTG のオープンレンジには入りません。後ろに 5 人残っており、'
          'コールされたときに支配されている（A や 9 が弱い）場面が多くなります。',
      gtoView:
          'ソルバーの UTG オープンレンジはオフスートエースだと AJo 前後が下限です。'
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          'KTs は BTN のオープンレンジに余裕で入るハンドです。'
          'ポストフロップで必ず最後に動ける有利さを活かし、レイズで主導権を取ります。',
      gtoView:
          'BTN のオープンレンジは 40% 以上まで広がるのが一般的で、'
          'KTs はその中でも上位に位置します。',
      practicalView:
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          'A5s は 3Bet ブラフの定番です。相手の AA・AK を減らすエースブロッカーを持ち、'
          'コールされてもフラッシュ・ストレートに向かえます。',
      gtoView:
          'BB の 3Bet レンジは「強いバリュー + ブロッカーのあるスーテッドエース」で'
          '構成されます。A5s はその後者の代表格です。',
      practicalView:
          '相手が 4Bet を多用するタイプなら 3Bet ブラフは減らし、'
    ...
    _make(
      ...
      correctIndex: 0,
      shortReason:
          '76s はオープンできる場面では魅力的ですが、UTG のタイトなレンジに'
          'コールで向かうと、後ろにまだ 3 人残っている状態で不利な戦いになります。',
      gtoView:
          'アーリーのオープンに対するコールレンジは、'
          'ポジションと後ろのプレイヤー数の分だけ狭くなります。',
      practicalView:
          'UTG が明らかに広くオープンしている相手なら、'
    ...
    _make(
      ...
      correctIndex: 1,
      shortReason:
          'コール額 6BB ÷（ポット 12 + ベット 6 + コール 6 = 24BB）= 25%。'
          '25% 以上の確率で勝てるならコールが利益になります。',
      gtoView:
          '相手のベットサイズは、そのままこちらが降りるべき頻度と結びついています。'
          '1/2 ポットベットに対しては、レンジ全体の約 25% 分だけ降りればバランスが取れます。',
      practicalView:
          '実戦では「25% 勝てるか」を厳密に計算するのではなく、'
    ...
    _make(
      ...
      correctIndex: 1,
      shortReason:
          'Q72 レインボーは相手にとって当たりづらいボードで、'
          'こちらのレンジが有利です。小さいサイズで広く、安くプレッシャーをかけます。',
      gtoView:
          '乾いた（ドローの少ない）ボードでレンジ有利な側は、'
          '小さいサイズを高頻度で使う形が基本です。',
      practicalView:
    ...
    _make(
      ...
      gtoView:
          'ドローが多いボードでは、バリューハンドのベットサイズが大きくなります。'
          '相手のエクイティを安く実現させないことが目的です。',
      practicalView:
          '相手がドローを追いかけがちなタイプなら、さらに大きく打って問題ありません。'
    ...
    _make(
      ...
      correctIndex: 1,
      shortReason:
          'フラッシュドローはターン以降で強くなれるので、'
          '今フォールドエクイティを取りつつ、当たったときの支払いも狙えるベットが有効です。',
      gtoView:
          'ドローを持ったハンドは、バリューハンドと同じサイズでベットに混ぜることで'
          'レンジ全体のバランスが取れます。',
      practicalView:
          '相手が K にほとんど降りないタイプなら、'
    ...
    _make(
      ...
      correctIndex: 0,
      shortReason:
          '765 は BB のコールレンジに強く当たり、こちらの UTG レンジには当たりません。'
          'レンジ全体が不利な場面では、無理に打たずポットを小さく保ちます。',
      gtoView:
          'ボードが相手のレンジに有利な場合、レンジ全体のベット頻度が大きく下がります。'
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          'ナッツフラッシュドローは、当たれば最強・外しても A ハイが残る強いドローです。'
          'ターンでは大きめに打ち、リバーの大きなポットを作りにいきます。',
      gtoView:
          'エクイティの高いドローは、大きいサイズのベットレンジに含まれます。'
          'バリューハンドと同じサイズで打つことで、リバーの選択肢も残ります。',
      practicalView:
          '相手が K をなかなか降ろさないなら、狙いは「降ろす」ではなく'
    ...
    _make(
      ...
      correctIndex: 0,
      shortReason:
          'エクイティもブロッカーもないハンドは、ターンでのブラフに向きません。'
          'チェックしてリバーで安く見せる、あるいは降りる準備をします。',
      gtoView:
          'ブラフに選ばれるのは、エクイティが残っているハンドか、'
    ...
    _make(
      ...
      actionHistory: [
        ...
        'リバー: BB check → BTN が大きくベット（ポットサイズ）',
      ],
      question: '3 ストリート打たれました。99 でどうしますか。',
      choices: ['Fold', 'Call', 'Raise', 'All-in'],
      correctIndex: 0,
      shortReason:
          '3 回打ち続けるレンジには A や K が多く、99 が勝てる相手はごく限られます。'
    ...
    _make(
      ...
      correctIndex: 1,
      shortReason:
          'QJs は今は QJ ハイですが、A・9・スペードで一気に最強クラスになります。'
          '降ろせれば良し、コールされても次で逆転できるセミブラフです。',
      gtoView:
          'セミブラフは「フォールドエクイティ」と「当たったときのエクイティ」の'
    ...
    _make(
      ...
      practicalView:
          'レンジ有利がある側は、小さいサイズで高頻度に打つのが基本方針になります。'
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          '降りない相手にブラフしても、チップを渡すだけです。'
          'この相手には「バリューを厚く、ブラフをほぼゼロに」が正解になります。',
      gtoView:
          'GTO ではリバーのブラフ頻度をバランスさせますが、'
          'それは相手が正しく降りてくることを前提にしています。',
      practicalView:
          '相手が降りないと分かっているなら、バランスを崩して'
          'バリューベットを増やすのが最も利益になります。これがエクスプロイトです。',
      commonMistake:
          '「ブラフも混ぜないとバランスが崩れる」と考えて、'
          '降りない相手にブラフしてしまうミスです。',
    ),
    _make(
      id: 'q017',
      ...
      correctIndex: 1,
      shortReason:
          'AK7 は相手のコールレンジに当たりにくく、'
          '降りやすい相手なら小さいベットで高い成功率が期待できます。',
      gtoView:
          'このボードはオープンした側のレンジ有利が大きく、'
          'GTO でも小さいサイズの高頻度ベットが基本になります。',
      practicalView:
          'タイトな相手に対しては、ベットの成功率が上がるぶん'
          'ブラフの本数を増やしてよい場面です。',
      commonMistake:
          '「何も当たっていないから打てない」と考えるミスです。'
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          'SB vs BB のヘッズアップでは K9o はレイズできる強さです。'
          'ポストフロップで不利なぶん、プリフロップで主導権を取ります。',
      gtoView:
          'SB のレイズファーストインレンジは 35〜40% 程度まで広がり、'
          'K9o はその中に含まれます。',
      practicalView:
    ...
    _make(
      ...
      correctIndex: 2,
      shortReason:
          'フラッシュドローのアウツは 9 枚。フロップからリバーまで 2 枚めくれるので、'
